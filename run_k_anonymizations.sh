...
echo "==============================================="
java -cp $ARX_CLASSPATH:build/classes syntheticmedical.KAnonymity2
java -cp $ARX_CLASSPATH:build/classes syntheticmedical.KAnonymity5
java -cp $ARX_CLASSPATH:build/classes syntheticmedical.KAnonymity10
java -cp $ARX_CLASSPATH:build/classes syntheticmedical.KAnonymity15
java -cp $ARX_CLASSPATH:build/classes syntheticmedical.KAnonymity2WithSuppression
java -cp $ARX_CLASSPATH:build/classes syntheticmedical.KAnonymity5WithSuppression
java -cp $ARX_CLASSPATH:build/classes syntheticmedical.KAnonymity10WithSuppression
java -cp $ARX_CLASSPATH:build/classes syntheticmedical.KAnonymity15WithSuppression
