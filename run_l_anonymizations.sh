...
echo "==============================================="
java -cp $ARX_CLASSPATH:build/classes syntheticmedical.L3Diversity2
java -cp $ARX_CLASSPATH:build/classes syntheticmedical.L3Diversity5
java -cp $ARX_CLASSPATH:build/classes syntheticmedical.L3Diversity10
java -cp $ARX_CLASSPATH:build/classes syntheticmedical.L3Diversity15
java -cp $ARX_CLASSPATH:build/classes syntheticmedical.L3Diversity2WithSuppression
java -cp $ARX_CLASSPATH:build/classes syntheticmedical.L3Diversity5WithSuppression
java -cp $ARX_CLASSPATH:build/classes syntheticmedical.L3Diversity10WithSuppression
java -cp $ARX_CLASSPATH:build/classes syntheticmedical.L3Diversity15WithSuppression
