 ...
 */
public class KAnonymity15WithSuppression extends Example {
    ...
    public static void main(final String[] args) {
        try {
            ...
            config.addCriterion(new KAnonymity(15));
            ...
            result.getOutput(false).save("dataset/anonymized_flash_k15_sup0.01.csv", '|');
