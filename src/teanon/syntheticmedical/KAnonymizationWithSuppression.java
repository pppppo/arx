 ...
 */
public class KAnonymizationWithSuppression extends Example {
    ...
    public static void main(final String[] args) {
        if(args.length < 1) {
            System.out.println("It requires K parameter!");
            return;
        }
        ...
        try {
            ...
            System.out.println(k + "\t" + result.getGlobalOptimum().getMaximumInformationLoss() + 
